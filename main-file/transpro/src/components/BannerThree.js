        ...
        <div className='banner-slider owl-carousel'>
          <Slider {...settings}>
            <div>
              <div
                className='item'
                style={{ background: "url('https://www.wowtheme7.com/tf/transpro/assets/version-2/img/slide-v1/bg-01.png')" }}
              >
                    ...
                    <div className='col-lg-4'>
                      <div className='img-wrap b-animate-6'>
                        <div className='img-file'>
                          <img src='https://www.wowtheme7.com/tf/transpro/assets/version-2/img/slide-v1/slide-01.png' alt='' />
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div>
              <div
                className='item'
                style={{ background: "url('https://transpro.wowtheme7.com/assets/img/slide-v1/bg-03.png')" }}
              >
                <div className='container'>
                  <div className='row'>
                    <div className='col-lg-8'>
                    ...
                    <div className='col-lg-4'>
                      <div className='img-wrap b-animate-6'>
                        <div className='img-file'>
                          <img src='https://transpro.wowtheme7.com/assets/img/slide-v1/slide-03.png' alt='' />
                        </div>
                      </div>
                    </div>
                  </div>
